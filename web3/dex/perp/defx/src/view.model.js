 ...
 * @description Retrieves the total earned points and the latest point details for a user by making authenticated requests to the API using the provided client instance and API secret. Returns a standardized response object containing the total points earned and the latest epoch's point amount and period, or an error message if the request fails.
 ...
 * @returns {Promise<Object>} A Promise that resolves to a response object containing the total earned points, latest point details, or an error message.
 */
export async function vmGetEarnedPoints(_instance, _apiSecret) {
    try {
